...
<div align="center">
	...
	<caption><h2 align="center" style="color:black;font-weight: bold; ">Faculty Of Computer System and Technology</h2></caption>
	...
	<tbody>
	            ...
	            <tr>
                    <td>1</td>
					<td>Daw Soe Soe Mon</td>
					<td>Associate Professor</td>
					<td>Control Systems</td>
				</tr>
	            <tr>
                    <td>2</td>
					<td>Daw Nyein Nyein Hlaing</td>
					<td>Associate Professor</td>
					<td>Microcontrollers, Computer Architecture II</td>
          </tr>
	        <tr>
          <td>3</td>
					<td>Daw Nu Nu Hlaing</td>
					<td>Lecturer</td>
					<td>Computer Architecture and Organization</td>
				</tr>
        <tr>
                    <td>4</td>
					<td>Dr.Myat Thuzar</td>
					<td>Lecturer</td>
					<td>Computer Networking II</td>
				</tr>
        <tr>
                    <td>5</td>
					<td>Daw Ei Nitar Tun</td>
					<td>Lecturer</td>
					<td>-</td>
				</tr>
	            <tr>
                    <td>6</td>
					<td>Daw Kaung Su Wai</td>
					<td>Lecturer</td>
					<td>Electronics</td>
          </tr>
	        <tr>
          <td>7</td>
					<td>Daw Ei Thandar Tun</td>
					<td>Tutor</td>
