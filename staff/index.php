<?php
  ...
  if(isset($login))
  {
$que=mysqli_query($conn,"select * from staff where email='$e' and password='$p'");
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default" style="border: 1px solid #66CCFF;">
                    ...
                    <div style="background-color: #FFFFFF;" class="panel-heading">
                        ...
                        <h3 style="font-weight: bold;font-size: 1.2em;color: #000000" class="panel-title">Please Sign In Staff</h3>
                    </center>
                    </div>
                    ...
                    <div class="panel-body" style="background-color:#0837c4">
                        ...
                        <!-- <div style="text-align: center;">
                            <a href="..\index.php?info=registration" style="text-decoration: none; color:white;">Sign Up</a>
                        </div> -->
                    </div>
                </div>
            </div>
