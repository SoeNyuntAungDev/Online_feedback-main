...
/*$sql=mysqli_query($conn,"select * from feedback where student_id='$users' and faculty_id='$faculty'");
...
// if(empty($quest13)==true)
//   // $quest13=$_POST['$quest13'];
// //else
//    $quest13="No suggession";
//  echo $quest13;

// //$quest14=$_POST['$quest14'];
// if(empty($quest14)==true)
  
//    $_POST['quest14']="No suggession";
//  echo  $_POST['quest14'];

$query="insert into feedback_staff values('','$uname','$quest1','$quest2','$quest3','$quest4','$quest5','$quest6','$quest7','$quest8','$quest9','$quest10','$quest11','$quest12','$quest13','$quest14','$quest15',now())";
...
echo "<h2 style='color:green'>Feedback successful ! Thank you for your giving feedback!</h2>";
}
...
<select name="faculty" class="form-control">
	<?php
  /*$sem=$users['semester'];
 // echo "<td>Testing".$sem."</td>";

  $year=$users['Class'];
 // echo $year;

  $section=$users['class_name'];
 // echo $section;
$sql=mysqli_query($conn,"select * from faculty where year='$year' and semester='$sem' and section='$section'" );

echo "<option>Select Teacher and Teaching Subject</option>";
	while($r=mysqli_fetch_array($sql))
	{
	echo "<option value='".$r['email']."'>".$r['Name']."                 (".$r['programme'].")</option>";
	}*/
		 ?>
</select>
</td>
...
<tr>
<td><b>1:</b>  Do you feel like you are treated with respect?</td>  
...
<tr>
<td><b>2:</b>Do you feel valued?</td> 
...
<tr>
<td>
<b>3:</b>Do you feel there is opportunity to grow?</td> 
<td>
...
<!-- <h3>2-Class Teaching</h3> -->
 <table  class="table table-bordered" >
<Td><b>4:</b> Do you enjoy on your job?</td>
...
<tr>
<td>
<b>5:</b> How can I better support you in your work?</td>
<td> 
...
<tr>
<td><b>6:</b> How likely is it that you would recommend this university to a friend?</td>
<td>
...
<tr><td>
<b>7:</b> How satisfied are you with the policies that this university sets? </td>
...
<tr>
<td>
<b>8:</b> How satisfied are you with the compensation package at this university?</td><td> 
...
<tr>
<td>
<b>9:</b> Do you feel connected to your coworkers?</td> 
...
<tr>
<td>
<b>10:</b> How happy are you at</td>
<td>
...
<!-- <h3>3-Class Assessment</h3> -->
 <table  class="table table-bordered" >
<tr>
<td><b>11:</b>How well does this university recongnize faculty for their achievements?</td>
<td>
...
<tr>
<td><b>12:</b>How respectfully do members of your department treat each other?</td>
<Td>
...
<tr>
<td><b>13:</b>How satisfied are you with your department leadership?</td>
<Td>
 <input type="radio" name="quest13" value="5" required> 5
...
<tr>
<td><b>14:</b>How satisfied are you with the opportunities for professional development at this university?</td>
<Td>
 <input type="radio" name="quest14" value="5" required> 5
  <input type="radio" name="quest14" value="4">4
  <input type="radio" name="quest14" value="3"> 3
<input type="radio" name="quest14" value="2">2
<input type="radio" name="quest14" value="1">1</td>
</tr>

</table>

<!-- <b>15:</b>Do you have any other comments,questions,or concerns?<br><br>
<center>
