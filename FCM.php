...
<div align="center">
	...
	<caption><h2 align="center" style="color:black;font-weight: bold; ">Faculty of Computational Mathematics</h2></caption>
	<thead>
	            <tr>
                    <th>No</th>
					<th>Name</th>
	...
	<tbody>				
	            ...
	            <tr>
                    <td>1</td>
					<td>Dr.Ei Phyo Wai</td>
					<td>Professor</td>
					<td>Introduction to Operating Research</td>

				</tr>
				 <tr>
          <td>2</td>
					<td>Daw Sandar Pa Pa Thein</td>
					<td>Associate Professor</td>
					<td>Mathematics of Computing IV</td>
         </tr>
				<tr>
          <td>3</td>
					<td>Daw May Thandar Oo</td>
					<td>Lecturer</td>
					<td>-</td>
        ...
        <tr>
          <td>4</td>
					<td>Daw Win Thinzar Htun</td>
					<td>Lecturer</td>
					<td>Calculus II,Numerical Analysis</td>
				</tr>
        <tr>
          <td>5</td>
					<td>U Myo Lin</td>
        ...
        <tr>
          <td>6</td>
					<td>Daw San San Swe</td>
					<td>Assistant Lecturer</td>
					<td>Distrete Mathematics</td>
				</tr>
        <tr>
          <td>7</td>
					<td>U Kyaw Zin Htun</td>
					<td>Tutor</td>
					<td>Calculus II</td>
				</tr>
        <tr>
          <td>8</td>
					<td>Daw Hsu Hlaing Hnin</td>
					<td>Tutor</td>
					<td>Calculus II</td>
				</tr>
