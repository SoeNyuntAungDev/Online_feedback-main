...
<table class="styled-table" width="55%">
	<caption><h2 align="center" style="color:black;font-weight: bold; ">First Semester Course(CS)</h2></caption>
	<thead>
	            <tr>
					<th>Subject Code</th>
					<th>Title</th>
...
<div align="center">
<table class="styled-table" width="55%">
	<caption><h2 align="center" style="color:black;font-weight: bold; ">First Semester Course(CT)</h2></caption>
	<thead>
	            <tr>
					<th>Subject Code</th>
					<th>Title</th>
...
<!--
    <div align="center">
    <table class="styled-table" width="55%">
	<caption><h2 align="center" style="color:black;font-weight: bold; ">Second Semester Course(CS)</h2></caption>
	<thead>
	            <tr>
					<th>Subject Code</th>
					<th>Title</th>
	...
	<tbody>
                ...
                <tr>
					<td>CST-202</td>
					<td>Mathematics of Computing(II)</td>
                ...
                <!-- <tr>
                    <td>CS-205<td>
					<td>Computer Application Techniques(II)</td>
