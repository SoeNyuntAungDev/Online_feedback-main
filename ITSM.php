...
<body>
	...
	<caption><h2 align="center" style="color:black;font-weight: bold; ">Information Technology Support and Maintenance Department</h2></caption>
	<thead>
	            <tr>
                    <th>No</th>
					<th>Name</th>
	...
	<tbody>
	            ...
	            <tr>
                    <td>2</td>
					<td>Daw Ni Ni Khine</td>
					<td>Associate Professor</td>
					<td>Supporting Skill(Office 365),Supporting Skill(Advanced 365)</td>
				</tr>
				<tr>
          <td>3</td>
					<td>Daw Wai Wai Myint</td>
					<td>Lecturer</td>
					<td>Supporting Skill(Office 365),Web Development PHP</td>
        </tr>
        <tr>
          <td>4</td>
					<td>Daw Hla Hla Htwe</td>
					<td>Lecturer</td>
					<td>HTML+CSS</td>
        </tr>
				<tr>
          <td>5</td>
					<td>Daw Myat Hsu Oo</td>
					<td>Lecturer</td>
					<td>-</td>
        </tr>
