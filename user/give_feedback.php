...
$query="insert into feedback values('','$uname','$faculty','$quest1','$quest2','$quest3','$quest4','$quest5','$quest6','$quest7','$quest8','$quest9','$quest10','$quest11','$quest12','$quest13',now(),'$y','$s','')";
...
echo "<option>Select Teacher and Teaching Subject</option>";
	...
	echo "<option value='".$r['email']."'>".$r['Name']."                 (".$r['programme'].")</option>";
		 ...
		 ?>
       <?php
         $sq = mysqli_query($conn, "select question from question ");
         $row = mysqli_fetch_array($sq);
      //  for ($i = 0; $i < $row . strlen($row); $i++)
      //    echo $row[$i];
          ?>
</select>
</td>
...
<tr><td>
<b>7:</b> Teacher's presentation was clear,loud and easy to understand:</td>
...
<tr>
<td>
<b>9:</b> Teacher is available and helpful during counselling hours:</td> 
...
<b>13:</b>Why I liked (or) unlike about the course:<br><br>
<center>
