<?php
  ...
  if(isset($login))
  {
$que=mysqli_query($conn,"select * from faculty where email='$e' and password='$p'");
        ...
        <ul class="dropdown-menu">
          ...
          <li class="hover-me"><a href="..\index.php?info=secondyear">Second Year<i class="fa fa-angle-right"></i></a>
           <div class="sub-menu-2">
             <ul>
               <li type="none"><a style="color: white" href="..\index.php?info=firstyear">CS</li>
               <li type="none"><a style="color: white" href="..\index.php?info=firstyear">CT</li>
             </ul>
           </div>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default" style="border: 1px solid #66CCFF;">
                    ...
                    <div style="background-color: #FFFFFF;" class="panel-heading">
                        ...
                        <h3 style="font-weight: bold;font-size: 1.2em;color: #000000" class="panel-title">Please Sign In Teacher</h3>
                    </center>
                    </div>
