...
<div align="center">
	...
	<caption><h2 align="center" style="color:black;font-weight: bold; ">Staff Of Finance</h2></caption>
	<thead>
	            <tr>
                    <th>No</th>
					<th>Name</th>
	...
	<tbody>
          ...
          <tr>
          <td>1</td>
					<td>Daw Swe Swe Oo</td>
					<td>Head of Division</td>	
				</tr>
        <tr>
          <td>2</td>
					<td>Daw Khin Moe Myint</td>
        ...
        <tr>
          <td>4</td>
					<td>Daw Lin Let Paing</td>
					<td>Accountant(4)</td>	
				</tr>
        <tr>
          <td>5</td>
					<td>Daw Su Myat Moe</td>
					<td>Accountant(4)</td>	
				</tr>
        <tr>
          <td>6</td>
					<td>Daw Thet Thet Oo</td>
					<td>Cashier(4)</td>	
				</tr>
        <tr>
          <td>7</td>
					<td>Daw Hnin Wai Lwin</td>
					<td>Cashier(4)</td>	
				</tr>
