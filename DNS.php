...
<body>
	...
	<caption><h2 align="center" style="color:black;font-weight: bold; ">Department of Natural Sciences</h2></caption>
	<thead>
	            <tr>
                    <th>No</th>
					<th>Name</th>
	...
	<tbody>
			    ...
			    <tr>
                    <td>2</td>
					<td>Daw Kyay Hmone Tun</td>
					<td>Associate Professor</td>
					<td>-</td>
        </tr>
	            <tr>
                    <td>3</td>
					<td>Daw San San Wai</td>
					<td>Lecturer</td>
					<td>-</td>
				</tr>
        <tr>
                    <td>4</td>
					<td>Daw Ei Zin Myint</td>
					<td>Lecturer</td>
					<td>Physics</td>
        </tr>
	            <tr>
                    <td>5</td>
					<td>Daw Ei Mon Zin</td>
