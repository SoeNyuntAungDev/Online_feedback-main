...
<div align="center">
	...
	<caption><h2 align="center" style="color:black;font-weight: bold; ">Staff Of Student Affair</h2></caption>
	<thead>
	            <tr>
                    <th>No</th>
					<th>Name</th>
	...
	<tbody>
	            ...
	            <tr>
                    <td>1</td>
					<td>Daw Khin Soe Han</td>
					<td>Staff-Officer</td>
				</tr>
        <tr>
                    <td>2</td>
					<td>Daw Khaing Thinzar Mg Mg</td>
					<td>Office Superintendent</td>
				</tr>
        <tr>
                    <td>3</td>
					<td>Daw Zin Win Shwe</td>
					<td>Branch Clerk</td>
				</tr>
        <tr>
                    <td>4</td>
					<td>Daw May Thu Aung</td>
					<td>Lower Clerk</td>
				</tr>
