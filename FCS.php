...
<div align="center">
	<table class="styled-table" class="center" width="55%">
	<caption><h2 align="center" style="color:black;font-weight: bold; ">Faculty of Computer Science</h2></caption>
	<thead>
	            <tr>
                    <th>No</th>
					<th>Name</th>
	...
	<tbody>
	            ...
	            <tr>
                    <td>1</td>
					<td>Dr.Aye Pa Pa Mya</td>
					<td>Professor</td>
					<td>Principle of Information Technology,Artificial Intelligence + Prolog</td>

				</tr>
				<tr>
                    <td>2</td>
					<td>U Than Htike Aung</td>
					<td>Associate Professor</td>
					<td>Java BlackBook (J2EE),Linux Fundamental and Administration OR Respberry PI</td>

				</tr>
	            <tr>
                    <td>3</td>
					<td>Daw Khin Mar Cho</td>
					<td>Associate Professor</td>
					<td>Principle of Information Technology,Analysis of Algorithm</td>
	            ...
	            <tr>
                    <td>5</td>
					<td>Daw Thuzar Win</td>
					<td>Lecturer</td>
					<td>Java Programming</td>
				</tr>
	            <tr>
                    <td>6</td>
					<td>Daw Hnin Hnin Ei Hlaing</td>
					<td>Lecturer</td>
					<td>C++ Programming</td>
				</tr>
				<tr>
                    <td>7</td>
					<td>Daw Ei Phyu Myint</td>
					<td>Lecturer</td>
					<td>Artificial Intelligence + Prolog</td>

				</tr>
        <tr>
                    <td>8</td>
					<td>U Htet Lin Aung</td>
					<td>Tutor</td>
					<td>Principle of Information Technology</td>
				</tr>
	            <tr>
                    <td>9</td>
					<td>Daw Aye Htet Aung</td>
					<td>Tutor</td>
					<td>Principle of Information Technology</td>
				</tr>
				<tr>
                    <td>10</td>
					<td>Daw Hnin Nandar Zaw</td>
					<td>Tutor</td>
					<td>Supporting Skill (Office 365),Supporting Skill (Advanced 365)</td>
