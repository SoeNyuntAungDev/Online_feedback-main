...
<td>
<select name="userName1" class="form-control">
<option >Select Department</option>
	...
	while ($r=mysqli_fetch_array($s)) {
		...
		?>
		<option value="<?php echo $department;  ?>"><?php echo $r['department'];?></option>
...
<td><input name="search1" type="submit" value="Search" class="btn btn-primary"/></td>
</tr>
</table>
</form>
...
if(isset($_POST['search1']))	{
   ...
   if($_POST['userName1']!='Select Department')
     {
...
//<?php 
	...
	$i=1;
	$que=mysqli_query($conn,"select * from faculty where department='$n'");
