    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#0837c4">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:white;font-weight: bold;">Online Student feedback System</a>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default" style="border: 1px solid #66CCFF;">
                    ...
                    <div style="background-color: #FFFFFF;" class="panel-heading">
                        ...
                        <h3 style="font-weight: bold;font-size: 1.2em;color: #000000" class="panel-title">Please Sign In Admin</h3>
                    </center>
                    </div>
