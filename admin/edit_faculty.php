<?php
	...
	{	
	// echo $n;
	$i=mysqli_query($conn,"update faculty set Name='$n',designation='$desg',programme='$prg',semester='$sem',year='$year',mobile='$mob',	password='$pass' where id='".$_GET['id']."'");	
if($i>0){
...
<div class="col-lg-8" style="margin:15px;background-color: #66CCFF;">
 ...
 <div class="control-group form-group">
  ...
  <input type="text"  name="year" value="<?php echo @$res['year'];?>" class="form-control" required>
	...
	<div class="control-group form-group">
    	<div class="controls">
            	<input type="submit" class="btn btn-primary" name="save" value="Update  Teacher">
        </div>
  	</div>
	</form>
